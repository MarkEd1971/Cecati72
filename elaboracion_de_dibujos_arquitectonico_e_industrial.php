...
<head>
  ...
  <title>Cecati 72 - ELABORACIÓN DE DIBUJOS ARQUITECTÓNICO E INDUSTRIAL</title>
...
<body>
  ...
  <section id="hero_dibu" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1><strong>ELABORACIÓN DE DIBUJOS ARQUITECTÓNICO E INDUSTRIAL</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Dibujo técnico asistido por computadora.</h3>
          <p><strong>Al finalizar el curso, el  egresado elaborará dibujos a mano libre y asistido por computadora, de acuerdo a las especificaciones técnicas para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Dibujo arquitectónico por computadora.</h3>
          <p><strong>Al finalizar el curso el egresado dibujará planos arquitectónicos en forma manual y asistida por computadora, de acuerdo a las especificaciones técnicas para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Dibujo asistido por computadora 3D.</h3>
