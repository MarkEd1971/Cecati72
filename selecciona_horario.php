...
if($horario11 != ''){
   ...
   // $url = 'http://'.$_SERVER["cecati72.com.mx/"].'cecati72.com.mx/reporte_b.php?us='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11.'';
     $url = 'us='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11.'';
    
   // $errores.= $n_e1.$n_curso1.$precio_c1.$correo;
    $inscripcion_al1 ="INSERT INTO inscripciones2 (especialidad, curso_h, dia, mes, año, sexo, edo_civil ,curp, nacionalidad, nombre, nombre2, apellido_p, apellido_m, telefono, celular, correo, direccion, colonia, cp, localidad, municipio, estado, n_estudio, t_sangre, s_medico, enfermedad, discapacidad, motivo, medio, socio_e, personas, estimacion, n_empresa, p_trabajo, antiguedad, d_empresa, t_empresa, bienes,fecha ,hora, link) VALUES ('$n_e1','$n_curso1','$dia_al','$mes_al','$anio_al','$sexo_al','$edo_civil','$alum_no','$nacionalidad','$nombre_al','$nombre2','$apellido_al','$apellido_m','$telefono','$celular','$correo','$direccion','$colonia','$cp','$localidad','$municipio','$estado','$n_estudio','$t_sangre','$s_medico','$enfermedad','$discapacidad','$motivo','$medio','$socio_e','$personas','$estimacion','$n_empresa','$p_trabajo','$antiguedad','$d_empresa','$t_empresa','$bienes','$fecha','$hora','$uurl')";
                $alta_al1 = $mysqli->query($inscripcion_al1); 
    
    
   /*$inscripcion_al1 ="INSERT INTO inscripciones2 (especialidad, curso_h, curp, correo,link) VALUES ('$n_e1','$n_curso1','$alum_no','$correo','$url')";
                $alta_al1 = $mysqli->query($inscripcion_al1); */
         ...
         $confirmacion .='<h2>Te registraste correctamente, se enviará un correo electronico con más detalles.</h2>'.'<br>';  
    
   // $confirmacion .= 'http://'.$_SERVER["cecati72.com.mx/"].'cecati72.com.mx/reporte_p1.php?us='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11.'';
    
    echo '<META HTTP-EQUIV="Refresh" CONTENT="5; URL=envio_de_correo_curp3.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11.'&clave_c2='.$curso2_s.'&claveh_2='.$horario12.'"></META>';
}
...
//$url = 'http://'.$_SERVER["cecati72.com.mx/"].'cecati72.com.mx/reporte_p1.php?us='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11;        
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Inscripción a la Especialidad de: </h2>
          <h2> <?php echo $n_curso.$nombre_cur2.
        $nombre_hora2; ?></h2>
                </div>
    </div>
  </main>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">          
            ...
            <br>
            <br>
            <h5 align="right"><strong>Sub totál: </strong><?php echo $precio_c1 ;?></h5>
            <h5 align="right"><strong>Totál: </strong> <?php echo $precio_c1 ;?></h5>
            
             <div class=" row justify-content-center">
            <center>
							<div class="col-xs-20">
								<form id="login-form"  method="GET" role="form" name="registro" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
									<!--<div class="form-group col-md-20">
										<input type="text" name="n_curso1" id="n_curso1" tabindex="1" class="form-control" placeholder="<?php echo $n_e2;?>" value="<?php echo $n_e2;?>"  hidden>
									</div>-->
                                    <!--<div class="form-group col-md-20">
                                    ...
                                    <div class="form-group col-md-20">
										<input type="text" name="clave_c1" id="clave_c1" tabindex="1" class="form-control" placeholder="<?php echo $curso1_s;?>" value="<?php echo $curso1_s;?>"  hidden>
									</div>
                                    <div class="form-group col-md-20">
										<input type="text" name="claveh_1" id="claveh_1" tabindex="1" class="form-control" placeholder="<?php echo $horario11;?>" value="<?php echo $horario11;?>"  hidden>
									</div>
                                     <div class="form-group col-md-20">
										<input type="text" name="id" id="id" tabindex="1" class="form-control" placeholder="<?php echo $id_clave;?>" value="<?php echo $id_clave;?>"  hidden>
									</div>
                                     <div class="form-group col-md-20">
										<input type="text" name="token" id="token" tabindex="1" class="form-control" placeholder="<?php echo $alum_no;?>" value="<?php echo $alum_no;?>"  hidden>
									</div>
                                    <div class="form-group col-md-20">
										<input type="text" name="pago" id="pago" tabindex="1" class="form-control" placeholder="<?php echo $alum_no;?>" value="true"  hidden>
									</div>
        ...
        <div class="modal-footer">
           <!-- <button type="button" class="btn btn-success"><a href="#" style="color:white;">Pagar</a></button>-->
<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
  ...
  <footer id="footer">
    <div class="footer-top">
      <div class="container">
         <h2>Hola <?php echo $nombre_al.'&nbsp;'.$apellido_al ;?></h2>
          <br>
          <h4 style="color: red;">Se ha seleccionado un curso de la especialidad de: <?php echo $n_curso; ?> <br> Te mostramos la lista de cursos que podria interesarte: </h4>
          Seleccióna el curso y horario en que desee inscribirse.
          <?php
            ...
            ';
                ...
                while($filas1 = $nomb_curso->fetch_row()){
                  ...
                  <!--  <td>'.$filas1[0].'</td>-->
                    ...
                    <td> $100.00 </td>
                    <!--<td>'.$filas1[3].'</td>-->
                    <td> <a href="selecciona_horario.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$cv_curso.'&claveh_1='.$filas1[0].'">Enviar solicitúd.</a></td>
                   <!-- <td><a href="seleccion_e1.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$cv_curso.'&claveh_1='.$filas1[0].'">Seleccionár con promoción</a></td>-->
                    <!--<td>'.$filas1[5].'</td>-->
                   <!-- <td>'.$filas1[3].'</td>-->
                    </tr>';
                } 
