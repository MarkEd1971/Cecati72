...
<head>
  ...
  <title>Cecati 72 - SOPORTE A INSTALACIONES ELÉCTRICAS Y MOTORES ELÉCTRICOS</title>
...
<body>
  ...
  <section id="hero_electrica" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>SOPORTE A INSTALACIONES ELÉCTRICAS Y MOTORES ELÉCTRICOS</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Instalación del sistema eléctrico residencial.</h3>
          <p><strong>Realizar instalaciones eléctricas residenciales cumpliendo con la interpretación de los planos eléctricos, los fundamentos de electricidad, las normas y procedimientos de seguridad e higiene, así como las especificaciones en el uso de equipo eléctrico, herramienta, material y accesorios e instrumentos de medición para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Instalación del sistema eléctrico industrial.</h3>
          <p><strong>Realizar instalaciones eléctricas industriales al interpretar los planos correspondientes para la aplicación de elementos eléctricos, respetando las normas y procedimientos de seguridad e higiene, protección al medio ambiente y las especificaciones en el uso de equipos eléctricos, herramientas, materiales y accesorios e instrumentos de medición, así como los lineamientos organizativos para proporcionar un servicio sin riesgos y de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento a motores eléctricos.</h3>
          <p><strong>Realizar el mantenimiento a motores eléctricos, mediante el diseño de un plan, la medición y documentación de las condiciones de operación, el diagnóstico y corrección del motor, así como la posterior verificación de su funcionamiento; de acuerdo a las especificaciones de la empresa y a las recomendaciones del fabricante y aplicando las normas de seguridad e higiene en el trabajo, para lograr así un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento a motores eléctricos.</h3>
          <p><strong>Realizar la reparación a los aparatos domésticos de acuerdo a los fundamentos de la electricidad y la mecánica, e interpretará los planos eléctricos, electrónicos e hidráulicos, normas y procedimientos de seguridad e higiene, utilizando las especificaciones en el uso de equipo eléctrico, herramienta, material y accesorios e instrumentos de medición para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
  <!-- ======= Footer ======= -->
  <footer id="footer">
