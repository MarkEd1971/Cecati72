...
<head>
  ...
  <title>Cecati 72 - ACCIONES MÓVILES</title>
...
<body>
  ...
  <section id="hero_movil" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>ACCIONES MÓVILES</strong></h1></center>
    </div>
  </section>
  <footer id="footer">
<div class="breadcrumbs">
      <div class="container">
       <h3>Las acciones móviles de capacitación son las que se caracterizan por ofrecer los servicios de formación para el trabajo fuera del plantel, es decir en aquellos lugares que lo requieran o donde hay poblaciones de mayor vulnerabilidad, mediante el desplazamiento del instructor del CECATI al lugar donde se solicita la capacitación, utilizando las instalaciones y equipo del solicitante.</h3>
      </div>
    </div>
