...
<head>
  ...
  <title>Cecati 72 - Examen ROCO</title>
...
<body>
  ...
  <section id="hero_roco" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1><strong>EXAMEN ROCO</strong></h1></center>
    </div>
  </section>
    <footer id="footer">
<div class="breadcrumbs" style="text-align: justify">
      <div class="container">
       <h3>Es el servicio educativo denominado Reconocimiento Oficial de la Competencia Ocupacional (ROCO), que se ofrece en los Centros de Capacitación para el Trabajo Industrial (CECATI) y que está enfocado en certificar mediante la expedición oficial de un Diploma tus conocimientos, habilidades, destrezas y actitudes correspondientes a una competencia ocupacional, sin importar cómo fueron adquiridos éstos.</h3>
      </div>
    </div>
      <div class="breadcrumbs1" style="text-align: justify">
      <div class="container">
       <h3>Si tienes experiencia en el desempeño de una actividad productiva o recibiste una formación previa y no tienes un documento oficial, <a href="contact.php">contactanos</a> y solicita este servicio.</h3>
      </div>
    </div>
