...
<head>
  ...
  <title>Cecati 72 - ASISTENCIA EJECUTIVA</title>
...
<body>
  ...
  <section id="hero_asis" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>ASISTENCIA EJECUTIVA</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Mecanografia asistida por computadora. (Curso Regular)</h3>
          <p><strong>Al finalizar el curso el egresado será capaz de operar los mecanismos de la máquina mecánica y/o electrónica, elaborando diferentes tipos de documentos utilizados en oficinas públicas y privadas, manejará equipo de cómputo y herramientas de Windows y Word, capturando y distribuyendo documentos de correspondencia comercial y oficial en diferentes unidades de la PC.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Taquigrafía. (Curso Regular)</h3>
          <p><strong>Al finalizar el curso el egresado será capaz de usar correctamente el material taquigráfico trazando y transcribiendo palabras y dictado oral y/o grabado a una velocidad de 90 a 100 palabras por minuto, utilizando el mobiliario, herramienta y suministros correspondientes.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Servicios secretariales. (Curso Regular)</h3>
          <p><strong>Al finalizar el curso el egresado atenderá al cliente, detectando sus necesidades y satisfaciéndolo con el servicio ofrecido, a través del cumplimiento de los procedimientos correspondientes con la aplicación de las medidas de seguridad e higiene y el uso del equipo necesario para proporcionar un servicio de calidad total.</strong></p>
      </div>
    </div>
  <footer id="footer">
