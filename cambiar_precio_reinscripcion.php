...
$r_precio = $ejecutar_precio->fetch_assoc();
          $n_precio = $r_precio['reinscripcion'];

if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $nuevo_precio = filter_var($_POST['nuevo_precio'],FILTER_SANITIZE_STRING);
    
     mysqli_query ($mysqli, "UPDATE precios set reinscripcion = '$nuevo_precio' WHERE id = '1'") or die ($errores .= '<li>Ha ocurrido un error en el servidor</li>');
         echo '<META HTTP-EQUIV="Refresh" CONTENT="0.1; URL=cambiar_precio_reinscripcion.php"></META>';
...
<header id="header" class="fixed-top">
  ...
  <main id="main"><br><br>
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Cambiar precio de reinscripción (General).</h2>
        <p></p>
      </div>
    </div>
       <div align="right"> <form action="busqueda.php" method="get" class="form_search">
           ...
           <br>
           <h2><strong> Precio general actual: $ <?php echo $n_precio; ?> &nbsp;&nbsp;&nbsp;</strong> </h2>
      </div>
