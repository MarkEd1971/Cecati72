...
<head>
  ...
  <title>Cecati 72 - OFIMÁTICA</title>
...
<body>
  ...
  <section id="hero_ofimatica" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>OFIMÁTICA</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Windows e Internet.</h3>
          <p><strong>Establecer vínculos entre las diferentes herramientas de cómputo, así como el uso y aplicación del correo electrónico, respetando las normas de seguridad aplicables al ramo y así otorgar un servicio de calidad.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Elaboración de textos.</h3>
          <p><strong>Elaborar documentos de texto mediante el manejo de archivos, bloques, secciones, tablas, imágenes, ventanas y vistas, así como hará uso de las herramientas de edición del procesador de textos, respetando las normas de seguridad aplicables al ramo para otorgar un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Elaboración de hojas de cálculo.</h3>
          <p><strong>Elaborar documentos de hojas de cálculo mediante herramientas de cómputo y de acuerdo a las especificaciones técnicas, respetando las medidas de seguridad e higiene aplicables para las personas y equipo y así otorgar un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Elaboración de presentaciones electrónicas.</h3>
          <p><strong>Desarrollar presentaciones electrónicas mediante el uso de gráficos, diagramas y objetos de dibujo y aplicando los procedimientos técnicos de diseño, edición y efectos de multimedia y con ello proporcionar presentaciones de calidad.</strong></p>
      </div>
    </div>
  <footer id="footer">
