...
<head>
  ...
  <title>Cecati 72 - BOLSA DE TRABAJO</title>
...
<body>
  ...
  <section id="hero_b_trabajo" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: black"><strong>BOLSA DE TRABAJO</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs" style="text-align: justify">
      <div class="container">
       <h3>El CECATI 72 proporciona gratuitamente el servicio de bolsa de trabajo a las empresas que soliciten personal técnico en cualquiera de las especialidades de capacitación para el trabajo que atiende actualmente.</h3> <br>
        <h3>  Los expedientes son integrados por alumnos con alto aprovechamiento, con actitudes positivas hacia el trabajo. </h3><br>
        <h3>  Las empresas solo necesitan llamar a nuestros teléfonos, registrar su vacante y el CECATI atenderá su solicitud proporcionando los egresados que requieran.</h3>
      </div>
    </div>
  <footer id="footer">
