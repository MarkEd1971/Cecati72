...
$correo = filter_var($_POST['correo2'],FILTER_SANITIZE_STRING);
...
if($correo != ''){
$url = 'http://'.$_SERVER["cecati72.com.mx/"].'cecati72.com.mx/registro_beca_cosoleacaque.php?id='.$id.'&r_correo='.$correo.'&cv='.$cv;
