...
<head>
  ...
  <title>Cecati 72 - ADMINISTRACIÓN</title>
...
<body>
  ...
  <section id="hero_ad" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>ADMINISTRACIÓN</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Administración en la micro y pequeña empresa. (Curso Regular)</h3>
          <p><strong>Al finalizar el curso, el  egresado administrará los recursos y operaciones de la empresa, de acuerdo con los planes establecidos y necesidades, para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Mercadotecnia en la micro y pequeña empresa. (Curso Regular)</h3>
          <p><strong>Al finalizar el curso el egresado elaborará un programa de comercialización que incluya promoción y pronósticos de ventas, compras y gastos, considerando la identificación de mercados, análisis de competidores y estrategias de mercadotecnia, que le permita eficientar los procedimientos de operación de un negocio y así proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Servicio y comunicación con el cliente. (Curso Regular)</h3>
          <p><strong>Al finalizar el curso, el egresado(a) establecerá la comunicación con el cliente y controlará la información derivada de ésta para brindar un servicio de calidad, de acuerdo tanto con los requerimientos y expectativas del cliente como con los lineamientos de la empresa.</strong></p>
      </div>
    </div>
  <footer id="footer">
