...
if($horario11 != ''){ 
   ...
   // $errores.= $n_e1.$n_curso1.$precio_c1.$correo;
    ...
    echo '<META HTTP-EQUIV="Refresh" CONTENT="5; URL=reporte_p.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11.'&clave_c2='.$curso2_s.'&claveh_2='.$horario12.'"></META>';
}
          ...
          echo '<div "table-responsive">
            ...
            ';
                ...
                while($filas1 = $nomb_curso->fetch_row()){
                  ...
                  <!--  <td>'.$filas1[3].'</td>-->
                    <td> $200.00 </td>
                    <td> <a href="seleccion_horario.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$cv_curso.'&claveh_1='.$filas1[0].'" target="_blank">Descargar arancel de pago.</a></td>
