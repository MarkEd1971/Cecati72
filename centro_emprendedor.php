...
<head>
  ...
  <title>Cecati 72 - CENTRO EMPRENDEDOR</title>
...
<body>
  ...
  <section id="hero_emprende" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>CENTRO DE EMPRENDEDORES DE LA EDUCACIÓN MEDIA SUPERIOR</strong></h1></center>
    </div>
  </section>
  <footer id="footer">
<div class="breadcrumbs" style="text-align: justify">
      <div class="container">
       <h3>El desarrollo insuficiente de competencias emprendedoras coloca a la gran mayoría de los egresados de la educación media superior casi frente a un único destino: empleos asalariados y de poca calidad, por lo que es necesario brindar a los jóvenes el apoyo y las herramientas que requieran para convertirse en emprendedores, si así lo desean.  </h3>
      </div>
    </div>
      <div class="breadcrumbs1" style="text-align: justify">
      <div class="container">
       <h3>Es por ello que la Secretaría de Educación Pública, a través de la Subsecretaria de Educación Media Superior, desarrolló el Modelo de Emprendedores para la Educación Media Superior (MEEMS), en colaboración con organizaciones de la sociedad civil - Ashoka, Angel Ventures México e Impulsa y los diferentes Subsistemas de la Educación Media Superior (EMS). </h3>
      </div>
    </div>
      <div class="breadcrumbs" style="text-align: justify">
      <div class="container">
       <h3>El enfoque del modelo está centrado en el desarrollo de competencias que refieren a una persona emprendedora, en particular a aquellos jóvenes que cursan el bachillerato, mediante la impartición del curso de "Desarrollo de Habilidades Emprendedoras", con la finalidad de que se integren en nuestro Centro Emprendedor para su vinculación con el ecosistema emprendedor. </h3>
      </div>
    </div>
      <br>
    <div class="footer-top">
      <div class="container">
        <div class="row">
 <center><br><br><h1>SI ESTAS INTERESADO(A) EN ESTE SERVICIO</h1>
