    ...
    $f_inscripcion3 ="INSERT INTO inscripciones2 (dia, mes, año, sexo, edo_civil ,curp, nacionalidad, nombre, nombre2, apellido_p, apellido_m, telefono, celular, correo, direccion, colonia, cp, localidad, municipio, estado, n_estudio, t_sangre, s_medico, enfermedad, discapacidad, motivo, medio, socio_e, personas, estimacion, n_empresa, p_trabajo, antiguedad, d_empresa, t_empresa, bienes,fecha ,hora) VALUES ('$dia','$mes','$anio','$sexo','$edo_civil','$curp','$nacionalidad','$nombre','$nombre2','$apellido_p','$apellido_m','$telefono','$celular','$correo','$direccion','$colonia','$cp','$localidad','$municipio','$estado','$n_estudio','$t_sangre','$s_medico','$enfermedad','$discapacidad','$motivo','$medio','$socio_e','$personas','$estimacion','$n_empresa','$p_trabajo','$antiguedad','$d_empresa','$t_empresa','$bienes_n','$fecha','$hora')";
     ...
     if($cv_curso >= 1){
                 ...
                 $confirmacion .='<h2>Completaste el formulario,en breve será redireccionádo para la selección del horario del curso de '.$n_curso.'.</h2>'.'<br>';
                     ...
                     echo '<META HTTP-EQUIV="Refresh" CONTENT="5; URL=seleccion_es.php?id='.$uss = hash('sha512',$curp).'&token='.$curp.'&cv='.$cv_curso.'"></META>';
                }else{
                    $confirmacion .='<h2>Completaste el formulario,en breve será redireccionádo para la selección del curso.</h2>'.'<br>';
 
                     echo '<META HTTP-EQUIV="Refresh" CONTENT="5; URL=seleccion_es.php?id='.$uss = hash('sha512',$curp).'&token='.$curp.'"></META>';
                }
...
<body>
  ...
  <main id="main">
    ...
    <!--  <div class="container">
        ...
        <h2>Bienvenido al registro</h2>
        <h2>Beca cosoleacaque</h2>
        <h3><?php if($n_curso != ''){ echo 'Curso seleccionado previamente: '.$n_curso;} ?></h3>
    </div>
  </main>
  <footer id="footer">
