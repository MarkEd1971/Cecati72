...
<head>
  ...
  <title>Cecati 72 - ¿Quienes somos?</title>
...
<body>
     <video  autoplay loop>
    <source src="assets/spot_cecati1.mp4" type="video/mp4"></video>
 ...
 <!-- <section id="hero_quienes" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: red"><strong>¿Quienes somos?</strong></h1></center>
    </div>
  </section>-->
  <footer id="footer" style="opacity: .40 ;">
  <div class="breadcrumbs1">
      <div class="container">
       <h3>Misión</h3>
          <p style="text-align: justify"><strong>Somos una institución educativa pública, que forma parte de la Dirección General de Centros de Formación para el Trabajo, adscrita a la Subsecretaria de Educación Media Superior de la Secretaria de Educación Pública, responsable de la formación para el trabajo de personas de 15 años o más, que certifica las competencias, con una actitud crítica, emprendedora y sustentable, determinante para la formación integral y la empleabilidad, atendiendo la demanda de diversos municipios de la región sur de Veracruz, que cuenta con personal profesional y comprometido,  una infraestructura física necesaria, un modelo educativo académico, relevante y pertinente a las demandas sociales.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs">
      <div class="container">
       <h3>Visión</h3>
          <p style="text-align: justify"><strong>Ser una institución líder con identidad propia, reconocida a nivel regional y estatal por la calidad y competitividad de sus servicios de formación para el trabajo; una organización que aprende, actualizada, dinámica y generadora de cambios; socialmente responsable, que contribuye a mejorar las condiciones de vida de la población, la productividad, el desarrollo económico y la transformación de México.</strong></p>
      </div>
    </div>
 ...
 <center><br><br><br><h1>SI ESTAS INTERESADO(A) EN ALGUNO DE NUESTROS CURSOS EN PLANTEL</h1>
            <h1>¡<a href="contact.php">CONTÁCTANOS</a> O <a href="inscripciones.php">INSCRÍBETE</a> YA!</h1>
     <br>
     <br>
     <br>
            </center>
