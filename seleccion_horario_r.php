...
if($horario11 != ''){ 
   ...
   // $errores.= $n_e1.$n_curso1.$precio_c1.$correo;
    ...
    /*  $inscripcion_al1 ="INSERT INTO inscripciones (especialidad, curso_h, curp, correo) VALUES ('$n_e1','$n_curso1','$alum_no','$correo')";
         ...
         $confirmacion .='<h2>Te registraste correctamente, en breve se rediccionará para descargar el arancel de pago.</h2>'.'<br>';  
    
    echo '<META HTTP-EQUIV="Refresh" CONTENT="5; URL=reporte_r.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario11.'&clave_c2='.$curso2_s.'&claveh_2='.$horario12.'"></META>';
          ...
          echo '<div "table-responsive">
            ...
            ';
                ...
                while($filas1 = $nomb_curso->fetch_row()){
                  ...
                  <!--  <td>'.$filas1[3].'</td>-->
                    <td> $200.00 </td>
                    <td> <a href="seleccion_horario_r.php?id='.$id_clave.'&token='.$alum_no.'&clave_c1='.$cv_curso.'&claveh_1='.$filas1[0].'" target="_blank">Descargar arancel de pago.</a></td>
