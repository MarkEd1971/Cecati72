...
<div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <section id="hero_in" class="d-flex justify-content-center align-items-center">
    ...
    <center><h2>Seleccióna el segundo curso.</h2><!--</center><p style="text-align: right">El proceso de inscripción es de 2 pasos. <a <?php $candado =1; echo 'href="index.php?id='.$candado = hash('sha512',$candado).'
...
&cv='.$filas[0].'&token='.$alum_no.'" style="color:black">'.$filas[1].'</a></td>
                    <td><a class="link_delete" href="seleccion_horario1.php?id='.$filas[0] = hash('sha512',$filas[0]).'
&cv='.$filas[0].'&token='.$alum_no.'&clave_c1='.$curso1_s.'&claveh_1='.$horario1.'">Inscribirse</a></td>
                   <!-- <td><a class="link_delete" href="inscripciones.php?id='.$filas[0] = hash('sha512',$filas[0]).'
