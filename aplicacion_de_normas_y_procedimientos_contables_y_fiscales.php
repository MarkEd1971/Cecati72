...
<head>
  ...
  <title>Cecati 72 - APLICACIÓN DE NORMAS Y PROCEDIMIENTOS CONTABLES Y FISCALES</title>
...
<body>
           ...
           <li class="drop-down"><a href="#">Especialidades</a>
            <ul>
             <li><a href="administracion.php">Administración</a></li>
              ...
              <li><a href="refrigeracion_y_aire_acondicionado.php">Refrigeración y Aire Acondicionado</a></li>            </ul>
          </li>
  ...
  <section id="hero_aplic" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1><strong>APLICACIÓN DE NORMAS Y PROCEDIMIENTOS CONTABLES Y FISCALES</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Contabilidad general con paquete contable. (Curso Regular)</h3>
          <p><strong>Contabilizar los eventos económicos de una empresa comercial y/o de servicios, mediante los procedimientos contables de identificación, organización y registro de información a través de formatos manuales, mecánicos y electrónicos, para apoyar y cumplir las obligaciones contables y fiscales del cliente de manera veraz y oportuna.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Contabilidad de costos asistida por computadora. (Curso Regular)</h3>
          <p><strong>Aplicar la contabilidad de costos asistida por computadora, apegándose a los procedimientos establecidos por la empresa así como en los documentos fuente o paquetes de registro electrónico del sistema contable y los formatos establecidos por las normas de información financiera aceptados (boletines emitidos por el Instituto de Contadores Públicos), para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Determinación de obligaciones fiscales. (Curso Regular)</h3>
          <p><strong>Determinar impuestos provisionales y anuales, declaraciones informativas de personas físicas y morales, así como retenciones de ISR por salarios de empresas y aportaciones obrero patronales de seguridad social, complementando los formatos impresos y por internet, de acuerdo a los cálculos y procedimientos establecidos por la normatividad fiscal vigente, para proporcionar al cliente y/o empresa un servicio de calidad.</strong></p>
      </div>
    </div>
  <footer id="footer">
