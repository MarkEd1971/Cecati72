...
<head>
  ...
  <title>Cecati 72 - REFRIGERACIÓN Y AIRE ACONDICIONADO</title>
...
<body>
  ...
  <section id="hero_aire" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>REFRIGERACIÓN Y AIRE ACONDICIONADO</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento de sistemas de aire acondicionado y refrigeración.</h3>
          <p><strong>Realizar el mantenimiento y verificación a los sistemas de aire acondicionado y refrigeración, de acuerdo a su tipo, procedimientos establecidos en un plan de trabajo y especificaciones técnicas, cumpliendo con las normas de seguridad, higiene y protección al ambiente correspondientes, otorgando un servicio de calidad al cliente.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento de refrigeradores tipo duplex.</h3>
          <p><strong>Realizar el mantenimiento de refrigeradores domésticos tipo duplex, respetando las normas de seguridad aplicables al ramo para otorgar un servicio de calidad.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento de clima tipo minisplit.</h3>
          <p><strong>Realizar el mantenimiento de climas tipo minisplit, respetando las normas de seguridad apliblables para otorgar un servicio de calidad.</strong></p>
      </div>
    </div>
  <footer id="footer">
