        ...
        <ul>
         ...
         <li><a href="https://forms.gle/CSB7ZX7EWEjdeCBYA">Inscripciones</a></li>
          <li><a href="contact.php">Contacto</a></li>
            ...
            <ul>
            <!--  <li><a href="index.php?ask=1">Clases en línea</a></li>-->
              <!--li><a href="registro.php">Nuevo ingreso</a></li>
              <li><a href="index.php?ask2=1">Reingreso</a></li>      
              <li><a href="registro_beca_cosoleacaque.php">Becas Cosoleacaque</a></li>
...
<div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <section id="hero_in" class="d-flex justify-content-center align-items-center">
    ...
    <!-- <center><h2>Especialidades.</h2></center><p style="text-align: right">El proceso de inscripción es de 2 pasos. <a <?php $candado =1; echo 'href="index.php?id='.$candado = hash('sha512',$candado).'
...
&cv='.$filas[0].'" style="color:black">'.$filas[1].'</a></td>
                    <td><a class="link_delete" href="index.php?id='.$filas[0] = hash('sha512',$filas[0]).'
&cv='.$filas[0].'&ask=1">Inscribirse</a></td>
                   <!-- <td><a class="link_delete" href="inscripciones.php?id='.$filas[0] = hash('sha512',$filas[0]).'
