...
$r_precio = $ejecutar_precio->fetch_assoc();
          $n_precio = $r_precio['cosolea'];

if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $nuevo_precio = filter_var($_POST['nuevo_precio'],FILTER_SANITIZE_STRING);
    
     mysqli_query ($mysqli, "UPDATE precios set cosolea = '$nuevo_precio' WHERE id = '1'") or die ($errores .= '<li>Ha ocurrido un error en el servidor</li>');
         echo '<META HTTP-EQUIV="Refresh" CONTENT="0.1; URL=cambiar_precio_cosoleacaque.php"></META>';
...
<header id="header" class="fixed-top">
  ...
  <main id="main"><br><br>
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Cambiar de precio de becas Cosoleacaque (General).</h2>
        <p></p>
      </div>
    </div>
