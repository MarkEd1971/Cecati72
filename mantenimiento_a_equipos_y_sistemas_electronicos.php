...
<head>
  ...
  <title>Cecati 72 - MANTENIMIENTO A EQUIPOS Y SISTEMAS ELÉCTRONICOS</title>
...
<body>
  ...
  <section id="hero_mantenimiento_e" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>MANTENIMIENTO A EQUIPOS Y SISTEMAS ELÉCTRONICOS</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento preventivo y correctivo de circuitos electrónicos análigos y digitales.</h3>
          <p><strong>Al finalizar el curso el egresado realizará la reparación de circuitos electrónicos analógicos y digitales, a través de la interpretación de diagramas esquemáticos electrónicos, del uso de equipos, herramientas y suministros, así como documentará las actividades que realice en servicios de mantenimiento, para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Mantenimiento de equipos receptores de televisión.</h3>
          <p><strong>Realizar el mantenimiento preventivo y correctivo de los equipos receptores de televisión, apegándose a los lineamientos de los manuales de servicio, la utilización de técnicas, rutinas, pruebas básicas, el uso de instrumentos de medición y la aplicación de las medidas de seguridad e higiene requeridas, para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
  <footer id="footer">
