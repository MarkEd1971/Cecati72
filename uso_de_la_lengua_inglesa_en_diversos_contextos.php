...
<head>
  ...
  <title>Cecati 72 - USO DE LA LENGUA INGLESA EN DIVERSOS CONTEXTOS</title>
...
<body>
  ...
  <section id="hero_lengua" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        <center><h1 style="color: white"><strong>USO DE LA LENGUA INGLESA EN DIVERSOS CONTEXTOS</strong></h1></center>
    </div>
  </section>
<div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Inglés comunicativo básico inicial.</h3>
          <p><strong>Comunicar mensajes en inglés usando estructuras básicas y utilizando un vocabulario sencillo y útil, para proporcionar un servicio de calidad.</strong></p>
      </div>
    </div>
      <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Inglés comunicativo básico superior.</h3>
          <p><strong>Comunicar mensajes en inglés en las cuatro grandes áreas: lectura de comprensión, comprensión auditiva, escritura y conversación, conforme a los criterios de evaluación establecidos.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs">
      <div class="container" style="text-align: justify">
       <h3>Inglés comunicativo preintermedio.</h3>
          <p><strong>Comunicar mensajes en inglés en las cuatro grandes áreas: lectura de comprensión, comprensión auditiva, escritura y conversación, conforme a los criterios de evaluación establecidos.</strong></p>
      </div>
    </div>
    <div class="breadcrumbs1">
      <div class="container" style="text-align: justify">
       <h3>Inglés comunicativo intermedio.</h3>
          <p><strong>Comunicar mensajes en inglés en las cuatro grandes áreas: lectura de comprensión, comprensión auditiva, escritura y conversación, conforme a los criterios de evaluación establecidos.</strong></p>
      </div>
    </div>
  <footer id="footer">
