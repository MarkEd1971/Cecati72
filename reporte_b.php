...
*/
///////////////////////////////////////////////////////
$consulta_us = "SELECT * FROM inscripciones2 where curp = '$uss' and id = '$cambio1'";
...
<p>DE FORMACIÓN PARA EL TRABAJO.</p></td>
  ...
  <h5>Curso al que me inscribo: '.$curso1h.'</h5>
  </td>  
  </tr>
  <tr>
    <td valign="top">
...
<h4>INSCRIPCION MECM001120MVZNDR04</h4>
    ...
    <br>
    <strong><p>inscripciones-c72@outlook.com</p>
    <br>
    <p>Con copia a:</p><br>
    <p>cecati72.ac1@dgcft.sems.gob.mx</p><br>
    <p>cecati72.avsp2@dgcft.sems.gob.mx</p>
    <br>
